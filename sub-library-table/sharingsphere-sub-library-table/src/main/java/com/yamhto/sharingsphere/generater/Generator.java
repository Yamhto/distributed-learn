package com.yamhto.sharingsphere.generater;
 ...
 * @package com.yamhto.cloud.mybatis.generater
 * @description:
 * @date 2020/3/9 17:50
 */
public class Generator {
    ...
    //数据库名字
    private static final String database = "share1";
    ...
    public static void main(String[] args) {
        generate("yamhto", "com.yamhto.sharingsphere", "");
    }
