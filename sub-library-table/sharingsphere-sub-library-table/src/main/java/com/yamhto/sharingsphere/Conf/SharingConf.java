...
/**
 * @author yamhto
 * @className: SharingConf.java
 * @package com.yamhto.sharingsphere.Conf
 * @description:
 * @date 2020/6/2 14:19
 */
@Configuration
public class SharingConf {

    @Autowired
    private JdbcConf jdbcConfig;
    ...
    private TableRuleConfiguration userRuleConfig() {
        ...
        tableRuleConfig.setActualDataNodes("ds${0..1}.user");
        ...
        //tableRuleConfig.setTableShardingStrategyConfig(new InlineShardingStrategyConfiguration("sex", "user${sex % 2}"));
